...
#define 是否可以骑马写入基址 0x16C93E0
#define g_坐骑 0xA9F24
#define g_坐骑_index单 0xA
#define g_坐骑_叠加单 0x23

#define g_行走状态 0x76C
#define g_是否骑马 0x4B10
#define 怪物目标 0x4F48


#define g_背包仓库头 0x6CC
#define g_公共仓库索引 0x8a570
#define 基址_小退call 0x28C0540
...
#define 新坐标寻路call 0x17FC6E0
#define 新坐标寻路rcx 0x4F05970

#define 基址_个人_遍历 0x4E88E00
#define 基址_个人_遍历偏移 0x190
#define 基址_个人_虚表数组偏移 0x7B8
#define 基址_个人_虚表数组头 0x328
#define 基址_个人_判断虚表 0x2B49D20
#define 基址_个人_坐标 0x4EED488
#define 基址_地图_寻路call 0x267E760
#define 基址_背包_遍历 0x4E97268
#define 基址_背包_获取名字call 0x6625B0
#define 基址_背包_获取名字rcx 0x4E88DF8
#define 基址_背包_使用物品call_rcx 0x2133560
#define 基址_背包_使用物品call 0x2A65CB0
#define 基址_背包_使用物品call2 0x2A64160
#define 基址_技能_快捷栏 0x4E97270
#define 基址_技能_获取名字call 0x1265BE0
#define 基址_技能_获取名字rcx 0x4E8AE10
#define 基址_环境_打开npc 0x28251D0
#define 基址_环境_npc对话标志 0x4EEF718
#define 基址_环境_是否处于加载界面 0x4EB49AC
#define 基址_任务_快捷栏 0x4E97328
#define 基址_任务_获取任务对象 0xCD1A40
#define 基址_坐骑_使用坐骑call 0x26A6650
#define 基址_个人_速度校验地址 0x275D4B4
#define 基址_环境_地图ID 0x4E97AF8
#define 基址_技能_使用技能call 0x267E760
#define 基址_任务_接任务call 0x11FBD20
#define 基址_环境_退出npc对话 0x4EEC6A8
#define 基址_任务_获取任务坐标 0x16FC460
#define 基址_地图_环境 0x4EF1B38
#define 基址_地图_获取环境名字call 0xE08F40
#define 基址_副本_入场HOOK地址 0x19C8A03
#define 基址_副本_入场CALL 0x1E13350
#define 基址_环境_判断动画 0x4EEE620
#define 基址_鼠标_鼠标写入地址 0x28541D6
#define 基址_鼠标_鼠标写入地址2 0x27F8F70
#define 基址_鼠标_坐标 0x4EED488
#define 基址_鼠标_游戏坐标转鼠标call 0x25B9FE0
#define 基址_鼠标_游戏坐标转鼠标rcx 0x4F260D0
#define 基址_新手_选择职业call 0x223FAA0
#define 基址_新手_退出体验call 0x21D74B0
#define 基址_新手_获取序幕对象rcx 0x4E88E00
#define 基址_直升_跳过序幕rcx 0x4EF1058
#define 基址_直升_跳过序幕call 0x102A320
#define 基址_新手_跳过序幕call 0x2A502C0
#define 基址_环境_传送call 0x14844E0
#define 基址_环境_传送rcx 0x4E8AE28
#define 基址_环境_传送点遍历 0x4EAABB8
#define 基址_环境_怪物是否死亡 0x2739040
#define 基址_环境_npc对话分支call 0x141CD20
#define 基址_封包_发包call 0x2940640
#define 基址_封包_发包rcx 0x4E88E08
#define 基址_技能_升级技能包头 0x3C83B10
#define 基址_个人_社交动作call 0x124C4F0
#define 基址_个人_社交动作rcx 0x4EEC6A0
#define 基址_背包_修理call 0x1515400
#define 基址_背包_修理rcx 0x4EEC6C8
#define 基址_副本_进入其他副本call 0x1E131A0
#define 基址_个人_复活包头 0x3E09AA8
#define 基址_环境_拾物call 0x2853730
#define 基址_地图_获取大地图名 0x285510
#define 基址_拍卖_获取剩余时间call 0x2BA2430
#define 基址_UI_按键参数 0x1EA4520
#define 基址_个人_乐谱遍历rcx 0x4E88DF8
#define 基址_个人_乐谱遍历rdx 0x4E57C3C
#define 基址_个人_乐谱遍历call 0x6C8890
#define 基址_个人_演奏乐谱call 0x1141890
#define 基址_个人_演奏乐谱rcx 0x4EF1B58
#define 基址_UI_航海出港call 0xD972F0
#define 基址_UI_航海出港rcx 0x4E97340
#define 基址_UI_航海入港call 0xDA0FD0
#define 基址_本人_修理船只call 0xD86BDE
#define 基址_地图_获取港口传送点ID 0x7F08D0
#define 基址_UI_准备出航call 0x2F92970
#define 基址_登录_选择服务器call 0x2678270
#define 基址_登录_选择服务器rcx 0x4EF0350
#define 基址_登录_确认协议call 0x2A4D1F0
#define 基址_登录_选择职业call 0x2666DD0
#define 基址_登录_选择职业rcx 0x4F1C788
#define 基址_登录_创建角色 0x1379AD0
#define 基址_登录_打开创建角色call 0x2A54E80
#define 基址_登录_进入游戏call 0x266D710
#define 基址_登录_进入游戏rcx 0x4EF1088
#define 基址_任务_获取任务地图ID 0x1636120
#define 基址_地图_目的地址是否可达Call 0x1826430
...
#define 基址_组队_遍历 0x4E97310
#define 基址_组队_离开队伍call 0x2941ED0
#define 基址_组队_离开队伍rcx 0x4E88E08
#define 基址_组队_离开队伍rdx 0x3BA2068
#define 基址_组队_踢出队伍call 0x2941ED0
#define 基址_组队_踢出队伍rdx 0x3C83CD0
#define 基址_组队_邀请队伍call 0x2941ED0
#define 基址_组队_邀请队伍rdx 0x3C83C60
#define 基址_组队_同意邀请call 0x251A220
#define 基址_个人_分解call 0x10242D0
#define 基址_个人_分解rcx 0x4EF4960
#define 基址_个人_打开分解call 0x21A8CE0
#define 基址_个人_打开分解rcx 0x4E88E00
#define 基址_个人_召唤宠物call 0x115E010
#define 基址_个人_召唤宠物rcx 0x4EEC6C8
#define 基址_任务_阶段任务完成call 0x1472950
#define 基址_拍卖_获取遍历对象rcx 0x4F04230
#define 基址_拍卖_登记物品遍历call 0x19751F0
#define 基址_拍卖_即使购买call 0xD9E4F0
#define 基址_拍卖_即使购买rcx 0x4EF1048
#define 基址_拍卖_登记封包头 0x3B7B200
#define 基址_战斗_是否战斗call偏移 0x350
#define 基址_背包_丢弃Rcx 0x4EED4F0
#define 基址_背包_丢弃CALL 0x14642F0
#define gc_SkillShortKeySet 0x11FBE20
#define gb_voyageLinerList 0x1
#define gb_ActorList 0x4E8AE20
#define go_hj_HideState 0xB4
#define gb_AttrList 0x4E97268
#define go_hj_myRole 0x4E4
#define gb_UiList 0x4E88E00
#define gb_ShortKey 0x4E97268
#define go_AttrList_off1 0xE4
#define go_bag_dSize 0x330
#define go_bag_offset2 0x28530
#define gb_ResBase 0x4E88DF8
#define go_Res_dtotal 0xD8
#define gb_QuestCur 0x4E97328
#define gb_QuestRes 0x4E88FA0
#define go_QuestStepCompStart 0x1578
#define gb_Str 0x4F20518
#define go_sk_offset 0x4AF4
#define go_SkillCurPreset 0xA9F08
#define go_ShortKey_CurPage 0xA8060
#define gb_MouseInfo 0x4EED488
#define gb_SceneMovie 0x4E8AF18
#define gb_EntranceInfo 0x4EEE628
#define go_DungeonMoviePass 0x108
#define gb_CurTeleportList 0x4EAABB8
#define go_RecomEquip 0x614
#define gc_WearEquip 0x26DD110
#define gc_UnWearEquip 0x1BEEEC0
#define gb_ActorTakeStatus 0x4EEC688
#define go_UiMsgStart 0x230
#define gc_CheckGuildQuest 0x2A26800
#define gb_GuildQuestList 0x4EF6718
#define gc_ShopBuyAddItem 0x14A8030
#define go_ShopBuyItemState 0x1E0
#define go_ShopBuyItemListStart 0x160
#define gc_ShopBuyItem 0x2461510
#define go_ShopListStart 0x94
#define gb_ShopBase 0x4F00D68
#define gc_GameListFree 0xD62370
#define gc_GetNpcQuestTalkCurList 0x26B4D10
#define gc_GetNpcQuestTalkResList 0x643530
#define gc_ExpressMailDel 0x2145170
#define gc_ExpressMailGetItemAll 0x21458F0
#define gc_ExpressMailSelectByIndex 0x1FE9AD0
#define gc_ExpressMailWndShowClick 0x1FE97D0
#define go_ExpressMailOpened 0x5D9
#define go_ExpressMailMoney1 0x120
#define go_ExpressMailMoney2 0x1
#define go_ExpressMailSize 0x4C38//需要每次确认检查 
#define go_ExpressMailCurSel 0x160
#define gb_ExpressMailList 0x4EED850
#define go_ExpressMailType 0xF8
#define go_ExpressMailState 0xE4
#define go_ExpressMailSenderName 0x10
#define go_ExpressMailTitle 0x3A
#define go_bag_Vehicle 0xA9F24
#define gb_CommonAction 0x4E8AE28
#define gc_ItemJobCheck 0xB02130
#define go_BS_RandomItemOpenAll 0x34
#define go_BSItem_ItemInfo 0x430
#define go_BSItem_WndInfo 0x424
#define gc_UseItem 0x2700FC0
#define gb_Attendance 0x4EF2B30
#define go_AttendanceListStart 0xC0
#define gc_AttendanceTake 0x11FB7A0
#define go_MousePoint 0x3EC
#define go_Role_FishObj 0x5ACC
#define go_Role_FishObj_State 0xF04
#define go_QuickSlotType 0x4C0
#define gc_MsgBoxConfirm 0x1D73470
#define go_PortalMapId 0x1FC
#define go_MarketUiSerchCheck 0x38C
#define gc_AuctionSearchStart 0xD9F060
#define go_AuctionDataSet 0x200
#define go_AuctionSearchState 0x660
#define gc_DataCopy 0xD49D30
#define gb_AuctionInfo 0x4EF1048
#define go_ExchangeShopWndTabVauleCtrl 0x41C
#define go_ExchangeShopWndTabCurVaule 0x558
#define gc_UIShowCtrl 0x21AEF80
#define gc_WelcomeChallengeLockCheck 0x16AEDE0
#define gb_WelcomeChallenge 0x4EF73A0
#define go_WelcomeChallengeMissionId 0x94
#define gc_WelcomeChallengeRewardTake 0x16ED990
#define gc_WelcomeChallengeTypeNewIndex 0x16AF330
#define go_ShopListSize 0x12C
#define gc_BarterShopEquipLevCheck 0x14B1D80
#define gc_BarterShopExchange 0x14AA2B0 //检查下是E9还是F9
#define gc_GetMoneyValue 0x26BD8F0
#define go_RoleMoneyListStart 0x120
#define go_PacketSocketObj 0x174
#define go_GameStageValue 0xE4
#define gb_PacketInfo 0x4E88E08
#define go_CharacterSrvId 0x208
#define go_CharacterLev 0x4BA4
#define go_CharacterName 0x4214
#define go_CharacterIndex 0x4BD2
#define go_CharacterJob 0x0
#define gb_CharacterList 0x4EF1088
#define go_CharacterListStart 0xA4
#define go_CharacterListSize 0x4C44
#define gc_hottimeEventRewardTake 0x163C310
#define gc_hottimeEventRewardCheck 0x1629F50
#define gb_hottimeEvent 0x4F041B0
#define go_PortalOpen 0xF04
#define gc_VoyageShipSelectShip 0x1BB67C0
#define go_VoyageCurShipId 0x100
#define gb_VoyageData 0x4E97340
#define gc_VoyageShipDelCrew 0xD5D680
#define gc_VoyageShipAddCrew 0xDB25D0
#define go_VoyageCrewTotal 0xA9F58
#define go_GetInteractPropState 0xBB8
#define go_hj_VehicleId 0x49FC
#define go_ActionTimingData 0x124
#define go_ActionTimingMaxTime 0x2DC
#define gb_ExpeditionRecdList 0x4E8AF08
...
#define gb_EngraveList 0x4EF3550
#define go_EngraveListStart 0x9C
#define gc_getAbilityResAddr 0x643C70
#define go_BookCurInfoStart 0x94
#define go_BookTakeedItemNum 0x98
#define go_BookRewardItemNum 0xE0
#define gb_BookCurInfo 0x4EF1030
#define go_BookCurPorcess 0xE4
#define gb_getBookReward包头 0x3DCECD0
#define go_getBookRewardSendArg 0x51
#define go_quickSlotFramePageArray 0x3E4
#define go_ActorShow 0x7F8
#define gc_ActorShow 0x1717320
#define gb_ChaosDungeonInfo 0x4EEF870
#define go_ChaosDungeonState 0xB5
#define go_BattleState 0xF2C
#define go_ItemAbilityTotal 0x45
#define go_ItemAbilityStartAddr 0x47
#define go_ItemAbilityStartOffset 0x4   //需要每次检查
#define go_ItemAbilityId 0x6   //需要每次检查
#define go_marbleWndItemListTotal 0x45C
#define go_marbleWndItemCurSel 0x44C
#define gc_marbleWndItemSelect 0x2336AF0
#define gc_marbleWndItemStartBtn 0x230B410
#define go_marbleWndItemListSize 0x360
#define go_marbleWndItemCntrType 0x884100
#define go_marbleWndItemSrvId 0x30
#define gc_MarbleNeedMake 0x230B410
#define go_ItemGradeLev 0x24
#define go_ItemBuildListStart 0x97C
#define go_ItemBuildListSize 0x394
#define gc_ItemBuildUpListSelectIndex 0x245F640
#define go_ItemBuildUpSelect 0x444
#define go_ItemBuildCurItemSrvId 0x480
#define gc_ItemBuildLevUpSucess 0x2379510
#define gc_ItemBuildLevUpResult 0x237FF10
#define gc_ItemBuildUpChildLevelUpGradeBtn 0x23A39B0
#define gc_ItemBuildUpLevelUpGrade 0x28EF5A0
#define gc_ItemBuildUpChildLevelUpBtn 0x23A2760
#define go_ItemBuildUpCurExp 0xB0
#define gc_ItemBuildUpMaxBtn 0x23CD0D0
#define gc_ItemBuildUpLevelUp 0x198B8F0
#define gc_CheckAbilityStone 0x1E9FE20
#define gc_CharacterGetJumpState 0x2649700
#define gb_CurSeverIndex 0x4E97AD8
#define gb_AccountSpecInfo 0x4E88E18
#define gc_AccountSpecCheck 0x261C30
#define gc_UesJumpByIndex 0x2674250
#define go_deadSceneTotal 0x48C
#define go_deadSceneStart 0x400
#define go_DeadSceneChildList 0x17C
#define gc_deadSceneWndBtn 0x1D408D0
#define gb_UnasTask 0x4EEF868
#define go_UnasWeeklyQuestStart 0xD4
#define go_UnasWeeklyQuestState 0x1514
#define go_UnasWeeklyQuestType 0x150C
#define go_UnasTaskWeekPoint 0x35A
#define go_UnasTaskDayPoint 0x358
#define gc_CheckUnasWeeklyQuestCon 0x26D5820
#define go_UseSkillOffset 0x110
#define go_ManPoBaseOffset 0x98
#define gc_UseSkillCall 0x26791E0
#define go_ItemGemCombineConfigValue 0x5C
#define gb_ItemGemCombineConfigSet 0x4EF1068
#define gc_ItemGemCombineConfigSet 0x1027900
#define gb_判断加载基址 0x4EEE5F0
#define go_加载偏移1 0xC0
#define go_加载偏移2 0x18
#define 偏移_本人_最大血 0x554
#define 偏移_本人_骑马状态 0x858
#define 偏移_本人_走路状态 0x4A0C
#define 偏移_个人_当前动作 0x110
#define 偏移_个人_当前怒气值 0x5ABC
#define 偏移_怪物_不可攻击偏移 0x5ABE
...
#define 偏移_环境_升降机标志 0x4E97B30
#define 偏移_拍卖_数组头 0xFF
#define 偏移_拍卖_数组大小 0x388
#define 偏移_拍卖_物品id 0x24
#define 偏移_拍卖_物品等级 0x96
#define 偏移_拍卖_立即购买 0x48
#define 偏移_拍卖_最低出价 0x370
#define g_坐骑 0xA9F24
#define g_坐骑_index单 0xA
#define g_坐骑_叠加单 0x23
#define 是否可以骑马写入基址 0x16C93E0
#define 基址_小退call 0x28C0540
#define 偏移_怪物_目标ID 0x4F48
