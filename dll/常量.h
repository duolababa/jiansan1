...
////////////////////////更新过了
#define 新坐标寻路call 0x17FD860
#define 新坐标寻路rcx 0x4F059A0

#define 基址_个人_遍历 0x4E88DE0
...
#define 基址_背包_获取名字call 0x662870
#define 基址_背包_获取名字rcx 0x4E88DD8
...
#define 基址_环境_打开npc 0x2824F20
#define 基址_环境_npc对话标志 0x4EEF6F8
#define 基址_环境_是否处于加载界面 0x4EB498C
#define 基址_任务_快捷栏 0x4E97308
#define 基址_任务_获取任务对象 0xCD2D80
#define 基址_坐骑_使用坐骑call 0x26A7190
#define 基址_个人_速度校验地址 0x275D944
#define 基址_环境_地图ID 0x4E97AD8
#define 基址_技能_使用技能call 0x267EB90
#define 基址_任务_接任务call 0x11FA5B0
#define 基址_环境_退出npc对话 0x4EEC688
#define 基址_任务_获取任务坐标判断 0x469C70
#define 基址_任务_获取任务坐标 0x16FD460
#define 基址_地图_环境 0x4EF1B18
...
#define 基址_鼠标_坐标 0x4EED468
#define 基址_鼠标_游戏坐标转鼠标call 0x25BA380
#define 基址_鼠标_游戏坐标转鼠标rcx 0x4F260D0
#define 基址_新手_选择职业call 0x2240880
#define 基址_新手_退出体验call 0x21D8440
#define 基址_新手_获取序幕对象rcx 0x4E88DE0
#define 基址_直升_跳过序幕rcx 0x4EF1038
#define 基址_直升_跳过序幕call 0x10289D0
#define 基址_新手_跳过序幕call 0x2A50C90
#define 基址_环境_传送call 0x1484AE0
#define 基址_环境_传送rcx 0x4E8AE08
#define 基址_环境_传送点遍历 0x4EAAB98
#define 基址_环境_怪物是否死亡 0x27397E0
#define 基址_环境_npc对话分支call 0x141DB40
#define 基址_封包_发包call 0x2940FE0
#define 基址_封包_发包rcx 0x4E88DE8
#define 基址_技能_升级技能包头 0x3C83E08
#define 基址_个人_社交动作call 0x124A820
#define 基址_个人_社交动作rcx 0x4EEC680
#define 基址_背包_修理call 0x1515BF0
#define 基址_背包_修理rcx 0x4EEC6A8
#define 基址_副本_进入其他副本call 0x1E13E50
#define 基址_个人_复活包头 0x3E09E28
#define 基址_环境_拾物call 0x2853720
#define 基址_地图_获取大地图名 0x284EB0
#define 基址_拍卖_获取剩余时间call 0x2371F30
#define 基址_UI_按键参数 0x1EA4520
#define 基址_个人_乐谱遍历rcx 0x4E88DD8
#define 基址_个人_乐谱遍历rdx 0x4E57C2C
#define 基址_个人_乐谱遍历call 0x6C8B50
#define 基址_个人_演奏乐谱call 0x113F720
#define 基址_个人_演奏乐谱rcx 0x4EF1B38
...
#define 基址_登录_选择服务器rcx 0x4EF0330
#define 基址_登录_确认协议call 0x2A4DC00
#define 基址_登录_选择职业call 0x26672D0
#define 基址_登录_选择职业rcx 0x4F1C788
#define 基址_登录_创建角色 0x137A1E0
#define 基址_登录_打开创建角色call 0x2A55810
#define 基址_登录_进入游戏call 0x266DC10
#define 基址_登录_进入游戏rcx 0x4EF1068
#define 基址_任务_获取任务地图ID 0x4D5E10
#define 基址_地图_目的地址是否可达Call新 0x17FD860
#define 基址_地图_目的地址是否可达RCX新 0x4F059A0
#define 基址_地图_目的地址是否可达Call 0x1827F30
#define 基址_地图_目的地址是否可达_rax获取偏移 0x338
#define 基址_地图_目的地址是否可达_r12偏移 0xEA8
#define 基址_地图_目的地址是否可达_r12获取偏移 0x1B8
#define 基址_地图_目的地址是否可达_rax偏移 0xF3C
#define 基址_组队_遍历 0x4E972F0
#define 基址_组队_离开队伍call 0x2942870
#define 基址_组队_离开队伍rcx 0x4E88DE8
#define 基址_组队_离开队伍rdx 0x3BA2118
#define 基址_组队_踢出队伍call 0x2942870
#define 基址_组队_踢出队伍rdx 0x3C83FC8
#define 基址_组队_邀请队伍call 0x2942870
#define 基址_组队_邀请队伍rdx 0x3C83F58
#define 基址_组队_同意邀请call 0x251A5E0
#define 基址_个人_分解call 0x1022980
#define 基址_个人_分解rcx 0x4EF4940
#define 基址_个人_打开分解call 0x21A9C90
#define 基址_个人_打开分解rcx 0x4E88DE0
#define 基址_个人_召唤宠物call 0x115BEC0
#define 基址_个人_召唤宠物rcx 0x4EEC6A8
#define 基址_任务_阶段任务完成call 0x1472F60
#define 基址_拍卖_获取遍历对象rcx 0x4F04220
#define 基址_拍卖_登记物品遍历call 0x1976940
#define 基址_拍卖_即使购买call 0xD9D860
#define 基址_拍卖_即使购买rcx 0x4EF1028
#define 基址_拍卖_登记封包头 0x3B7B290
#define 基址_战斗_是否战斗call偏移 0x350
#define 基址_背包_丢弃Rcx 0x4EED4D0
#define 基址_背包_丢弃CALL 0x1464E40
#define gc_SkillShortKeySet 0x11FA6B0
#define gb_voyageLinerList 0x1
#define gb_ActorList 0x4E8AE00
#define go_hj_HideState 0xB4
#define gb_AttrList 0x4E97248
#define go_hj_myRole 0x4E4
#define gb_UiList 0x4E88DE0
#define gb_ShortKey 0x4E97248
#define go_AttrList_off1 0xE4
#define go_bag_dSize 0x330
#define go_bag_offset2 0x28530
#define gb_ResBase 0x4E88DD8
#define go_Res_dtotal 0xD8
#define gb_QuestCur 0x4E97308
#define gb_QuestRes 0x4E88F80
...
#define gb_MouseInfo 0x4EED468
#define gb_SceneMovie 0x4E8AEF8
#define gb_EntranceInfo 0x4EEE608
#define go_DungeonMoviePass 0x108
#define gb_CurTeleportList 0x4EAAB98
#define go_RecomEquip 0x614
#define gc_WearEquip 0x26DDC70
#define gc_UnWearEquip 0x1BF00E0
#define gb_ActorTakeStatus 0x4EEC668
#define go_UiMsgStart 0x230
#define gc_CheckGuildQuest 0x2A27110
#define gb_GuildQuestList 0x4EF66F8
#define gc_ShopBuyAddItem 0x14A8630
#define go_ShopBuyItemState 0x1E0
#define go_ShopBuyItemListStart 0x160
#define gc_ShopBuyItem 0x2461890
#define go_ShopListStart 0x94
#define gb_ShopBase 0x4F00D48
#define gc_GameListFree 0x1BC3AA0
#define gc_GetNpcQuestTalkCurList 0x26B5850
#define gc_GetNpcQuestTalkResList 0x6437F0
#define gc_ExpressMailDel 0x2146090
#define gc_ExpressMailGetItemAll 0x2146810
#define gc_ExpressMailSelectByIndex 0x1FEA520
#define gc_ExpressMailWndShowClick 0x1FEA220
...
#define gb_ExpressMailList 0x4EED830
...
#define gb_CommonAction 0x4E8AE08
#define gc_ItemJobCheck 0xB01B90
#define go_BS_RandomItemOpenAll 0x34
#define go_BSItem_ItemInfo 0x430
#define go_BSItem_WndInfo 0x424
#define gc_UseItem 0x2701C40
#define gb_Attendance 0x4EF2B10
#define go_AttendanceListStart 0xC0
#define gc_AttendanceTake 0x11FA030
#define go_MousePoint 0x3EC
#define go_Role_FishObj 0x5ACC
#define go_Role_FishObj_State 0xF04
#define go_QuickSlotType 0x4C0
#define gc_MsgBoxConfirm 0x1D744B0
#define go_PortalMapId 0x1FC
#define go_MarketUiSerchCheck 0x38C
#define gc_AuctionSearchStart 0xD9E3D0
#define go_AuctionDataSet 0x200
#define go_AuctionSearchState 0x660
#define gc_DataCopy 0xD49900
#define gb_AuctionInfo 0x4EF1028
#define go_ExchangeShopWndTabVauleCtrl 0x41C
#define go_ExchangeShopWndTabCurVaule 0x558
#define gc_UIShowCtrl 0x21AFF30
#define gc_WelcomeChallengeLockCheck 0x16AF450
#define gb_WelcomeChallenge 0x4EF7380
#define go_WelcomeChallengeMissionId 0x94
#define gc_WelcomeChallengeRewardTake 0x16EE970
#define gc_WelcomeChallengeTypeNewIndex 0x16AF9A0
#define go_ShopListSize 0x12C
#define gc_BarterShopEquipLevCheck 0x14B2380
#define gc_BarterShopExchange 0x14AA8B0 //检查下是E9还是F9
#define gc_GetMoneyValue 0x26BE420
#define go_RoleMoneyListStart 0x120
#define go_PacketSocketObj 0x174
#define go_GameStageValue 0xE4
#define gb_PacketInfo 0x4E88DE8
...
#define gb_CharacterList 0x4EF1068
#define go_CharacterListStart 0xA4
#define go_CharacterListSize 0x4C44
#define gc_hottimeEventRewardTake 0x163C660
#define gc_hottimeEventRewardCheck 0x162A410
#define gb_hottimeEvent 0x4F041A0
#define go_PortalOpen 0xF04
#define gc_VoyageShipSelectShip 0x1BB7D10
#define go_VoyageCurShipId 0x100
#define gb_VoyageData 0x4E97320
#define gc_VoyageShipDelCrew 0xD5CDC0
#define gc_VoyageShipAddCrew 0xDB1890
...
#define gb_ExpeditionRecdList 0x4E8AEE8
...
#define gc_marbleWndItemSelect 0x2336DB0
#define gc_marbleWndItemStartBtn 0x230BCF0
#define go_marbleWndItemListSize 0x360
#define go_marbleWndItemCntrType 0x884100
#define go_marbleWndItemSrvId 0x30
#define gc_MarbleNeedMake 0x230BCF0
#define go_ItemGradeLev 0x24
#define go_ItemBuildListStart 0x97C
#define go_ItemBuildListSize 0x394
#define gc_ItemBuildUpListSelectIndex 0x245F9C0
#define go_ItemBuildUpSelect 0x444
#define go_ItemBuildCurItemSrvId 0x480
#define gc_ItemBuildLevUpSucess 0x2379830
#define gc_ItemBuildLevUpResult 0x2380190
#define gc_ItemBuildUpChildLevelUpGradeBtn 0x23A3C70
#define gc_ItemBuildUpLevelUpGrade 0x28EF750
#define gc_ItemBuildUpChildLevelUpBtn 0x23A2A20
#define go_ItemBuildUpCurExp 0xB0
#define gc_ItemBuildUpMaxBtn 0x23CD390
#define gc_ItemBuildUpLevelUp 0xC15520
#define gc_CheckAbilityStone 0x1EA07E0
#define gc_CharacterGetJumpState 0x2649BF0
#define gb_CurSeverIndex 0x4E97AB8
#define gb_AccountSpecInfo 0x4E88DF8
#define gc_AccountSpecCheck 0x261A30
#define gc_UesJumpByIndex 0x2674680
#define go_deadSceneTotal 0x48C
#define go_deadSceneStart 0x400
#define go_DeadSceneChildList 0x17C
#define gc_deadSceneWndBtn 0x1D418C0
#define gb_UnasTask 0x4EEF848
...
#define gc_CheckUnasWeeklyQuestCon 0x26D6330
#define go_UseSkillOffset 0x110
#define go_ManPoBaseOffset 0x98
#define gc_UseSkillCall 0x2679610
#define go_ItemGemCombineConfigValue 0x5C
#define gb_ItemGemCombineConfigSet 0x4EF1048
#define gc_ItemGemCombineConfigSet 0x1025FB0
#define gb_判断加载基址 0x4EEE5D0
...
#define g_坐骑_index单 0xA
#define g_坐骑_叠加单 0x23
#define 是否可以骑马写入基址 0x16C9EA0
#define 基址_小退call 0x28C04F0
