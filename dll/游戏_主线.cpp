		...
		if (主线任务.dStep == 2)
		{
			if (主线任务.子任务进度.size() == 4)
			{
				...
				if (主线任务.子任务进度[1].dCur < 主线任务.子任务进度[1].dNeed)
				{
					...
					if (功能::优先打怪(100))
					{
						if (GetDis(8327, 6423, 256) < 100)
						{
							if (主线任务.子任务进度[1].dCur == 0)
							{
								功能::到指定地点打开NPC(大陆ID, 地图ID, 8327, 6423, 256, 1000, 11258);
							...
							if (主线任务.子任务进度[1].dCur == 1)
							{
								功能::到指定地点打开NPC(大陆ID, 地图ID, 8327, 6423, 256, 1000, 11362);
							...
							{
								功能::到指定地点打开NPC(大陆ID, 地图ID, 8327, 6423, 256, 1000, 11361);
						...
						{
							if (功能::优先破坏击打道具(1000))//if (功能::移动打怪(8327, 6423, 256, 200, 500, 600))
							{
								功能::到指定地点(任务坐标.大陆ID, 任务坐标.地图ID, 8327, 6423, 256, 100);
							}
						}
